...
use LayeredArchitecture\Database\DatabaseConnection;
use LayeredArchitecture\Model\User;

/**
 * User Repository
 * 
 * This class is part of the Persistence layer and handles data access for User entities.
 * It uses the Database layer to interact with the database.
 */
