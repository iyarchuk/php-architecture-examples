...
namespace NTierArchitecture\Presentation;

use NTierArchitecture\Business\UserService;
use NTierArchitecture\Model\User;

/**
 * User Controller
 * 
 * This class is part of the Presentation tier and handles user requests and responses.
 * It uses the Business tier to perform operations.
 */
class UserController
{
    ...
    {
        // Call the business tier to get the user
        $user = $this->userService->getUserById($userId);
        ...
        try {
            // Call the business tier to update the user
    ...
    public function deleteUser(int $userId): array
    {
        ...
        // Call the business tier to delete the user
